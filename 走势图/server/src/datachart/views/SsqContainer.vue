<template>
    <div class="l-full l-flex-column syxw">
        ...
        <div class="ui-navbox">
            <div class="ui-navbox-in">
                <ul>
                    ...
                    <li :class="{'select':~$route.path.indexOf('houqu.html')||~$route.path.indexOf('HqCgzd.html')||~$route.path.indexOf('HqLbzd.html')}">
                        <router-link :to="{path: 'houqu.html'}" replace>蓝球</router-link>
                    </li>
                    ...
                    <li :class="{'select':~$route.path.indexOf('qianqu.html')||~$route.path.indexOf('QqDx.html')||~$route.path.indexOf('QqJo.html')||~$route.path.indexOf('QqZh.html')}">
                        <router-link :to="{path: 'qianqu.html'}" replace>红球</router-link>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="zous-foot-new-wrap" v-if="~$route.path.indexOf('houqu.html')||~$route.path.indexOf('HqCgzd.html')||~$route.path.indexOf('HqLbzd.html')">
            <div class="zous-foot-qh">
                <span :class="{'on':~$route.path.indexOf('houqu.html')}"><router-link :to="{path: 'houqu.html'}" replace >分布</router-link></span>
                <span :class="{'on':~$route.path.indexOf('HqCgzd.html')}"><router-link :to="{path: 'HqCgzd.html'}" replace>常规振荡</router-link></span>
                <span :class="{'on':~$route.path.indexOf('HqLbzd.html')}"><router-link :to="{path: 'HqLbzd.html'}" replace>0-8振荡</router-link></span>
            </div>
        </div>
