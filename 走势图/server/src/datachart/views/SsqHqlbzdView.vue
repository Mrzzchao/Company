                                ...
                                <table class="zstable2 zstable2-main zstable2-zuh">
                                    ...
                                    <tr v-for="row in zdzs">
                                        <template v-for="idx in $route.meta.zdNum">
                                            <td  v-if="row.xhzd[idx-1]==='0'">
                                                <span >{{idx-1}}</span>
                                            </td>
                                        </template>
                                        <td v-for="idx in $route.meta.zdNum" :class="{'on':row.xhzd[idx-1]==='0'}">
                                            <span :class="{on: row.xhzd[idx-1]==='0'}">{{row.xhzd[idx-1]==='0'?idx-1:row.xhzd[idx-1]}}</span>
                                        </td>
                                    </tr>
                                    </tbody>
                                </table>
