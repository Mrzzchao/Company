                        ...
                        <table class="zstable2 zstable2-main zstable2-yil">
                            ...
                            <tbody>
                                <tr v-for="item in list">
                                    ...
                                    <template v-for="idx in num">
                                        <td v-if="item['reddx'+idx]" :class="{'tdbg2':item['reddx'+idx][0]==='0','bdr2':idx===1}">{{item['reddx'+idx][0]==='0'?'奇':item['reddx'+idx][0]}}</td>
                                        <td v-if="item['reddx'+idx]" :class="{'tdbg1':item['reddx'+idx][1]==='0'}" class="bdr2">{{item['reddx'+idx][1]==='0'?'偶':item['reddx'+idx][1]}}</td>
                                    </template>
                                </tr>
                            </tbody>
