        ...
        <div class="ui-navbox">
            <div class="ui-navbox-in">
                <ul>
                    ...
                    <li :class="{'select':~$route.path.indexOf('/hz.html')}">
                        <router-link  :to="{path: 'hz.html'}" replace>和值</router-link>
                    </li>
                    <li :class="{'select':~$route.path.indexOf('/q1.html')}">
                        <router-link :to="{path: 'q1.html'}" replace>前一分布</router-link>
                    </li>
                </ul>
            </div>
        </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            nav(params) {
                this.$router.replace({name: params.type, params: {area: this.$route.params.area}});
            }
        },
        mounted() {
